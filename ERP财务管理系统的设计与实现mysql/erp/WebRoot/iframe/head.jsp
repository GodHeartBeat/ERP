...
<TABLE height=29 cellSpacing=0 cellPadding=0 width=900 align=center background=<%=basePath %>images/gaobei_top2.gif border=0>
  <TBODY>
  <TR>
    <TD width=93></TD>
    <TD vAlign=center width=210>
      <DIV style="PADDING-BOTTOM: 6px; COLOR: #ffffff">
      <SCRIPT src="<%=basePath %>images/date.js" type=text/javascript></SCRIPT>
      <SPAN id=time></SPAN>
