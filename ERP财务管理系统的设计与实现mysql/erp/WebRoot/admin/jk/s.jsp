...
{//String mc="";String zz="";String lx=""; String sj=""; String ym=""; String zy=""; String pic=""; String bz=""; 
	 ...
	 if(document.form1.jkxm.value=="")
	 {
		alert("请填写信息主题！");
		document.form1.jkxm.focus();
		return false;
	}
	form1.submit();
}
...
%>
<body>
<form action="<%=basePath%>admin/jk/sinfo.jsp" name="form1" method="post" >
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody> 
    ...
    <tr>
      ...
      <td class="td_bg" align=left><input type="text" name="jkxm" size="50" maxlength="30" ></td>
    </tr>
