...
%>
<body>
<form action="<%=basePath%>admin/js/sinfo4.jsp" name="form1" method="post" >
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody> 
    
    
    <tr>
      <td class="td_bg" width="35%" height="23" align=right>年度：</td>
      <td class="td_bg" align=left><select name=ysnd> 
    ...
    </select> 年  <input type="button" value="确定" onClick="check()"> </td>
    </tr>
