...
DefaultCategoryDataset dataset = new DefaultCategoryDataset();
 ...
 if(!zyList.isEmpty()){
 	for(int i=0;i<zyList.size();i++){
 		...
 		float str=cb.getFloat("select sum(jkje) from jk where bmmc='"+list2.get(1).toString()+"' and sj>='"+ksj+"'  and sj<='"+esj+"'");
...
JFreeChart chart = ChartFactory.createBarChart3D("借款信息统计图","部门","金额",dataset,PlotOrientation.VERTICAL,false,false,false);
