...
%>
<body>
<form action="<%=basePath%>admin/bmyh/sinfo.jsp" name="form1" method="post" >
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody> 
    
    
    <tr>
      <td class="td_bg" width="35%" height="23" align=right>登录帐号：</td>
      <td class="td_bg" align=left><input type="text" name="username" size="50" maxlength="30" ></td>
    </tr>
