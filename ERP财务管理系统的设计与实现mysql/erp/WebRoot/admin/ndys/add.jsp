...
String message = (String)request.getAttribute("message");
	...
	String id="";
		String ysmc="";String ysnd="";String ysje=""; String xx="";  
		if(method.equals("upndys")){
			id=request.getParameter("id");
			List wzlist=cb.get1Com("select * from ndys where id='"+id+"'",5);
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#BBD3EB">
  <tbody> 
    ...
    <tr bgColor=#ffffff>
      <td  class="font1"  width="35%" height="23" align=right>预算年度：</td>
      <td  class="font1"  align=left><select name=ysnd>
<%if(method.equals("upndys")){ %><option value=<%=ysnd %>><%=ysnd %></option><%} %>	 
